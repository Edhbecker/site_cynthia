    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">
              Arquiteta especializada em criar espaços que conectam emocionalmente
              com quem os vive. Transformando sonhos em realidade há mais de 10 anos.
            </p>
          </div>
            ...
            <div className="space-y-4 text-gray-300">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm">(49) 99999-9999</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm">cynthia@arquitetura.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm">@cynthia.arquiteta</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-rose-antique rounded-full flex items-center justify-center hover:bg-white hover:text-rose-antique transition-colors"
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Cynthia Aparecida da Silva - Arquiteta. Todos os direitos reservados.</p>
          <p className="mt-2">CAU/SC XXXXX-X | CREA/SC XXXXX-X</p>
        </div>
      </div>
    </footer>
  );
